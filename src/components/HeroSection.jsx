...
function HeroSection() {
    ...
    return (
        <section className="flex justify-center bg-[#fafafa] h-9/10">
            <div className="h-full flex justify-center items-center w-sm">
                <div className="flex flex-col gap-6">
                    ...
                    <a href="#" className="bg-[#6624EB] text-white px-8 py-6 rounded-md mt-6 shadow-md font-semibold">Faça um orçamento</a>
                </div>
            </div>
        </section>
    )
